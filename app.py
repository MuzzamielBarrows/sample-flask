...
def getViewersData(box_ids, store_acc_info, start, end):
...
def getOTSData(box_ids, store_acc_info, start, end):
...
def main():
    ...
    viewers_data = getViewersData(box_ids, store_acc_info, start, end)
    print("Finished Viewers Data")

    print("Getting OTS Data")
    ots_data = getOTSData(box_ids, store_acc_info, start, end)
